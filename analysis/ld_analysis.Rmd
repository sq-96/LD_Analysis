...
```{r,message=FALSE,results=FALSE,echo=FALSE,eval=FALSE}
system("/software/plink-1.90-el7-x86_64/plink --bfile /project2/xinhe/1kg/1000G_EUR_Phase3_plink/1000G.EUR.QC.10 --keep ./data/EUR_subpop1.txt --chr 10 --from-bp 18681005 --to-bp 18770105 --write-snplist --maf 0.05 --r2 --matrix --out ./data/chr10_18681005_18770105_EUR/chr10_18681005_18770105_EUR_subpop1")

system("/software/plink-1.90-el7-x86_64/plink --bfile /project2/xinhe/1kg/1000G_EUR_Phase3_plink/1000G.EUR.QC.10 --keep ./data/EUR_subpop2.txt --chr 10 --from-bp 18681005 --to-bp 18770105 --write-snplist --maf 0.05 --r2 --matrix --out ./data/chr10_18681005_18770105_EUR/chr10_18681005_18770105_EUR_subpop2")

system("/software/plink-1.90-el7-x86_64/plink --bfile /project2/xinhe/1kg/1000G_EUR_Phase3_plink/1000G.EUR.QC.10 --keep ./data/EUR_subpop3.txt --chr 10 --from-bp 18681005 --to-bp 18770105 --write-snplist --maf 0.05 --r2 --matrix --out ./data/chr10_18681005_18770105_EUR/chr10_18681005_18770105_EUR_subpop3")

system("/software/plink-1.90-el7-x86_64/plink --bfile /project2/xinhe/1kg/1000G_EUR_Phase3_plink/1000G.EUR.QC.10 --chr 10 --from-bp 18681005 --to-bp 18770105 --write-snplist --maf 0.05 --r2 --matrix --out ./data/chr10_18681005_18770105_EUR/chr10_18681005_18770105_EUR")
```
...
```{r,message=FALSE,results=FALSE,echo=FALSE,eval=FALSE}
system("/software/plink-1.90-el7-x86_64/plink --bfile /project2/xinhe/1kg/1000G_EUR_Phase3_plink/1000G.EUR.QC.15 --keep ./data/EUR_subpop1.txt --chr 15 --from-bp 91416560 --to-bp 91429040 --write-snplist --maf 0.05 --r2 --matrix --out ./data/chr15_91416560_91429040_EUR/chr15_91416560_91429040_EUR_subpop1")

system("/software/plink-1.90-el7-x86_64/plink --bfile /project2/xinhe/1kg/1000G_EUR_Phase3_plink/1000G.EUR.QC.15 --keep ./data/EUR_subpop2.txt --chr 15 --from-bp 91416560 --to-bp 91429040 --write-snplist --maf 0.05 --r2 --matrix --out ./data/chr15_91416560_91429040_EUR/chr15_91416560_91429040_EUR_subpop2")

system("/software/plink-1.90-el7-x86_64/plink --bfile /project2/xinhe/1kg/1000G_EUR_Phase3_plink/1000G.EUR.QC.15 --keep ./data/EUR_subpop3.txt --chr 15 --from-bp 91416560 --to-bp 91429040 --write-snplist --maf 0.05 --r2 --matrix --out ./data/chr15_91416560_91429040_EUR/chr15_91416560_91429040_EUR_subpop3")

system("/software/plink-1.90-el7-x86_64/plink --bfile /project2/xinhe/1kg/1000G_EUR_Phase3_plink/1000G.EUR.QC.15 --chr 15 --from-bp 91416560 --to-bp 91429040 --write-snplist --maf 0.05 --r2 --matrix --out ./data/chr15_91416560_91429040_EUR/chr15_91416560_91429040_EUR")
```
...
#### Pairwise correlation of the $i^th$ eigenvectors
```{r,echo=FALSE}
vector_cor_df <-rbind(cor_cal(vector1,vector2),cor_cal(vector1,vector3),cor_cal(vector2,vector3),
                      cor_cal(vector1,vector4),cor_cal(vector2,vector4),cor_cal(vector3,vector4))
rownames(vector_cor_df) <- c("sub1.vs.sub2","sub1.vs.sub3","sub2.vs.sub3",
